    ...
    options: [
      {
        ...
        options: [
          ...
          {
            name: "reason",
            description: "motivo de silencio",
      ...
      {
        name: "unmute",
        description: "reactivar la voz de un miembro silenciado",
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: "user",
          ...
          {
            name: "reason",
            description: "motivo para activar el silencio",
            type: ApplicationCommandOptionType.String,
            required: false,
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            name: "reason",
            description: "razón para quedar sordo",
            type: ApplicationCommandOptionType.String,
            required: false,
          },
        ],
      },
      {
        ...
        options: [
          ...
          {
            name: "reason",
            description: "razón para ser sordo",
            type: ApplicationCommandOptionType.String,
            required: false,
          },
        ],
      ...
      {
        name: "move",
        description: "mover un miembro de un canal de voz a otro",
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: "user",
          ...
          {
            name: "channel",
            description: "el canal al que mover el miembro",
