...
module.exports = {
    ...
    options: [
      {
        ...
        options: [
          {
            name: "channel",
            description: "Canal desde el cual se deben limpiar los mensajes.",
          ...
          {
            name: "amount",
            description: "número de mensajes a eliminar (máx. 99)",
      ...
      {
        name: "bots",
        description: "purgar todos los mensajes del bot",
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: "channel",
      ...
      },
      {
        ...
        options: [
          ...
          {
            name: "token",
            description: "token que se buscará en los mensajes",
      ...
      },
      {
        ...
        options: [
          ...
          {
            name: "user",
            description: "usuario cuyos mensajes necesitan ser limpiados",
  ...
  async interactionRun(interaction) {
    ...
    if (typeof response === "number") {
      return interaction.followUp(`Se limpiaron correctamente los mensajes ${response} en ${channel}`);
    }

    // Member missing permissions
    else if (response === "MEMBER_PERM") {
      return interaction.followUp(
        `No tienes permisos para leer el historial de mensajes y administrar mensajes en ${channel}`
      );
    }

    // Bot missing permissions
    else if (response === "BOT_PERM") {
      return interaction.followUp(`No tengo permisos para leer el historial de mensajes ni administrar mensajes en ${channel}`);
    }

    // No messages
    else if (response === "NO_MESSAGES") {
      return interaction.followUp("No se encontraron mensajes que se puedan limpiar.");
    }
