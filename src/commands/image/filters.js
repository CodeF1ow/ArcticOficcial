...
module.exports = {
  name: "filter",
  description: "añade filtro a la imagen proporcionada",
  cooldown: 5,
  category: "IMAGE",
  ...
  slashCommand: {
    ...
    options: [
      ...
      {
        name: "usuario",
        description: "el usuario cuyo avatar necesita el filtro aplicado",
        type: ApplicationCommandOptionType.User,
        required: false,
      },
      {
        name: "enlace",
        description: "el enlace de la imagen a la que se debe aplicar el filtro",
        type: ApplicationCommandOptionType.String,
        required: false,
      },
    ],
  ...
  async messageRun(message, args, data) {
    ...
    // utilizar invoke como un endpoint
