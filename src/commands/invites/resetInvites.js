...
module.exports = {
  name: "resetinvites",
  description: "borrar las invitaciones agregadas de un usuario",
  category: "INVITE",
  ...
  slashCommand: {
    ...
    options: [
      {
        name: "user",
        description: "El usuario para borrar invitaciones para",
...
async function clearInvites({ guild }, user) {
  ...
  return `Hecho! Invitaciones borradas para \`${user.username}\``;
}
