...
module.exports = {
  name: "rank",
  description: "muestra la clasificación de los miembros en este servidor",
  cooldown: 5,
  category: "STATS",
...
async function getRank({ guild }, member, settings) {
  ...
  if (!memberStats.xp) return `${user.username} aún no está clasificado!`;
  ...
  if (!response.success) return "No se pudo generar la tarjeta de clasificación";
