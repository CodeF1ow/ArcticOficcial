...
module.exports = {
  name: "statstracking",
  description: "habilitar o deshabilitar las estadísticas de seguimiento en el servidor",
  category: "STATS",
...
async function setStatus(input, settings) {
  ...
  return `Configuración guardada! El seguimiento de estadísticas es ahora ${status ? "activado" : "desactivado"}`;
}
