...
module.exports = {
  ...
  description: "configura la traducción de banderas en el servidor",
  category: "ADMIN",
...
async function setFlagTranslation(input, settings) {
  ...
  return `Se ha guardado la configuración! La traducción de banderas ahora está ${status ? "habilitada" : "deshabilitada"}`;
}