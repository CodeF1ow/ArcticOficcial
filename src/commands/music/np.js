...
module.exports = {
  name: "np",
  description: "muestra qué pista se está reproduciendo actualmente",
  category: "MUSIC",
...
function nowPlaying({ client, guildId }) {
  ...
  if (!player || !player.queue.current) return "🚫 No se reproduce música!";
