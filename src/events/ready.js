...
module.exports = async (client) => {
  ...
  if (client.config.MUSIC.ENABLED) {
    ...
    client.logger.success("Gestor de musica iniciado");
  }

  // Initialize Giveaways Manager
  if (client.config.GIVEAWAYS.ENABLED) {
    client.logger.log("Iniciando gestor de sorteos...");
    client.giveawaysManager._init().then((_) => client.logger.success("Gestor de sorteos iniciado"));
  }
