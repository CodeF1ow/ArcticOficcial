...
module.exports = {
  ...
  handleContext: async function (interaction, context) {
    ...
    if (context.cooldown) {
      ...
      if (remaining > 0) {
        return interaction.reply({
          content: `Estás en tiempo de reutilización. Puede volver a utilizar el comando después ${timeformat(remaining)}`,
          ephemeral: true,
        });
      }
    }
    ...
    try {
      ...
      interaction.followUp("Oops! Se produjo un error al ejecutar el comando.");
